...
secrets = {
  ...
  "stag_new_postgres_DbHost": "{{stag_new_postgres_DbHost}}",
  "stag_new_postgres_DbUser": "{{stag_new_postgres_DbUser}}",
  "stag_new_postgres_DbPswd": "{{stag_new_postgres_DbPswd}}",
  "stag_new_mysql_DbHost": "{{stag_new_mysql_DbHost}}",
  "stag_new_mysql_DbUser": "{{stag_new_mysql_DbUser}}",
  "stag_new_mysql_DbPswd": "{{stag_new_mysql_DbPswd}}"
}
