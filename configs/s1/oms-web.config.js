// OMS-Web Configuration - S1
module.exports = {
  API_HOST: 'http://localhost:8080/api',
  GEOMARK_API_KEY: '5e7LiT7366AmSIi1mxxeYRXo',
  GEOMARK_API_URL: 'https://s1-geomark-api.orangehealth.dev',
  ...
  OH_WEB_URL_NEW: 'https://s1-partner-order.orangehealth.dev',
  OH_WEB_URL: 'https://s1-web.orangehealth.dev',
  ...
  OMS_FEEDBACK_URL: 'https://s1-feedback.orangehealth.dev',
  OMS_PARTNER_TOKEN: '9ibRUd64VwXCCAuL84uQ3PmP',
  RTPCR_MASTERTEST_ID: 461,
  SUPERLAB_URL: 'https://s1-superlab.orangehealth.dev',
  SERVER_HOST: 'https://s1-oms.orangehealth.dev',
  SERVER_PORT: 8182,
  SRF_CITY_CONFIGS: {
    BLR: {
      otpRequired: true,
