...
AWS_BUCKET = 's2-oh-media'
PRIVATE_S3_BUCKET = 's2-oms-orders'
##########################################################################
# Celery config
CELERY['BROKER_TRANSPORT_OPTIONS']['region'] = 'ap-south-1'
CELERY['BROKER_TRANSPORT_OPTIONS']['queue_name_prefix'] = 's2-health-'
...
# # Celery config
CELERY['CELERY_RESULT_BACKEND'] = 'redis://redis:6379/3'
##########################################################################
...
SCHEDULER_SETTINGS['BASE_URL'] = 'http://scheduler-api/'
##########################################################################
...
FIREBASE_STORAGE_BUCKET = 's2-23e7c.firebasestorage.app'
firebase_app = firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://s2-23e7c-default-rtdb.firebaseio.com/',
...
##########################################################################
WEB_BASE_URL = 'https://s2-web.orangehealth.dev'
##########################################################################
S3_BASE_URL = 'https://s2-media.orangehealth.dev'
##########################################################################
API_BASE_URL = 'https://s2-api.orangehealth.dev'
##########################################################################
...
CORS_ORIGIN_WHITELIST = [
    f"https://s2-web.orangehealth.dev",
    f"https://s2-www.orangehealth.dev",
    f"https://s2-web-order.orangehealth.dev",
    f"https://s2-partner.orangehealth.dev",
    f"https://s2-sapphire-web.orangehealth.dev",
    "http://localhost:8081",
    "http://localhost:8082",
    "http://localhost:8000",
    "http://accounts-api:8000"
]
##########################################################################
...
CEREBRO_SETTINGS['BASE_URL'] = "https://s2-cerebro.orangehealth.dev"
CEREBRO_SETTINGS['SECRET_KEY'] = "Y4WEgs3kPHYGuphFbYr0fby66U8INjh8"
##########################################################################
STAG_PHC_BASE_URL = f"https://s2-www.orangehealth.dev/products/personalised-health-checkup/summary?id=<questionnaire_id>"
PROD_PHC_BASE_URL = "https://s2-www.orangehealth.dev/products/personalised-health-checkup/summary?id=<questionnaire_id>"
STAG_OMS_REQUEST_URL = f"https://s2-oms-<city_code>.orangehealth.dev/request/<oms_request_id>"
PROD_OMS_REQUEST_URL = "https://s2-oms-<city_code>.orangehealth.dev/request/<oms_request_id>"
##########################################################################
PHC_LEAD_DELAY = '1800'
##########################################################################
# Microservice Odin API creds
ODIN_SETTINGS["BASE_URL"] = 'https://s2-odin-api.orangehealth.dev'
...
PUBLISH_TOPIC_SETTINGS = {
    "CONTACT_MERGE_CONFIRM": {
        "SOURCE": "health",
        "TOPIC_ARN": "arn:aws:sns:ap-south-1:267224240039:s2-contact-merge-confirm",
    }
}
...
SUBSCRIBE_EVENT_DETAILS = {
    "CONTACT_MERGE": {
        "TOPIC_ARN": "arn:aws:sns:ap-south-1:267224240039:s2-contact-merge-request",
    },
    "REPORT_HP_SYNC_COMPLETE": {
        "TOPIC_ARN": "arn:aws:sns:ap-south-1:267224240039:s2-groot-report-hp-sync-complete",
    }
}
SUBSCRIPTION_QUEUE_URL = (
    "https://sqs.ap-south-1.amazonaws.com/267224240039/s2-health-consumer"
)
...
GROOT_SETTINGS["BASE_URL"] = "https://groot-api.orangehealth.in"
#GROOT_SETTINGS["SECRET_KEY"] = "mynameisgroot"
GROOT_SETTINGS["SECRET_KEY"] = "mynameisgrootsdfg3235rw"
